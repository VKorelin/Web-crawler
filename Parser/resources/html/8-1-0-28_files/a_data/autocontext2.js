...
Begun.DOM_TIMEOUT = 1;
Begun.REVISION = '$LastChangedRevision: 29223 $';
...
if (!Begun.Autocontext && Begun.Scripts.isLastRequired(fileName)) {
	Begun.Autocontext = new function(){
		...
		var Module = (function() {
			var ext = ['auto_ppcall','auto_scroll','auto_rich','auto_accordion','auto_top','auto_catalog','toolbar','catalog_tree'];
			var loaded = [];
			return {
...
#begun_block_{{block_id}} #begun_adv_square_{{block_id}}.transparentBorders .begun_adv_table td .begun_adv_block {\
_position:relative !important;\
_z-index:5000000 !important;\
}\
#begun_block_{{block_id}} #begun_adv_square_{{block_id}} .begun_adv_all *,\
#begun_block_{{block_id}} #begun_adv_square_{{block_id}} .begun_adv_sys * {\
background-color: {{block:backgroundColor}} !important;\
...
';
			html['block_square'] = '\
<table id="begun_adv_square_{{block_id}}" class="begun_adv begun_adv_ext begun_adv_square {{begun_alco_id}} banners_count_{{banners_count}} {{transparent_borders_class}}"{{block_hover}} style="width:{{block_width}}">\
<tr>\
<td class="begun_adv_cell">\
<table class="begun_adv_sys"><tr>\
<td class="begun_adv_sys_logo" style="display:{{logo_display}}"><div><a href="{{begun_url}}" target="_blank" class="snap_noshots">begun</a></div></td>\
